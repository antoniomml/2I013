...
class GoalSearch(object):
    ...
    def begin_round(self,team1,team2,state):
        ...
        ball = Vector2D(120.,45.) #PRUEBA DE TIRO A PUERTA
...
class BuscaPase(object):
    ...
    def begin_round(self,team1,team2,state):
        ...
        ball = Vector2D(75.,45.) #PRUEBA DE PASE

        # Player and ball postion
        self.simu.state.states[(1,0)].position = ball.copy() # Player1 position
        self.simu.state.states[(1,0)].vitesse = Vector2D() # Player1 acceleration

        self.simu.state.states[(1,1)].position = Vector2D(35.,20.) # Player2 position
        self.simu.state.states[(1,1)].vitesse = Vector2D() # Player2 acceleration
